...
/*Timer 2*/
#define TCCR2  (*((volatile uint8_t*)0x45)) /*8 bits registers*/
#define TCNT2  (*((volatile uint8_t*)0x44)) /*8 bits registers*/
#define OCR2 (*((volatile uint8_t*)0x43)) /*8 bits registers*/
/**********************************************************
* External Interrupt
**********************************************************/
